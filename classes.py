...
class Line:
    ...
    def get_abs_val_without_sqr(self):
        """ returns the absolute value, but without the square-root. useful for fast calculations """
...
def check_line_for_duplicate(line1: Line, line2: Line):
    ...
    if (line1.ver1.x == line2.ver1.x and line1.ver2.x == line2.ver2.x) or (
            line1.ver1.x == line2.ver2.x and line1.ver2.x == line2.ver1.x):
        # now y
        if (line1.ver1.y == line2.ver1.y and line1.ver2.y == line2.ver2.y) or (
                line1.ver1.y == line2.ver2.y and line1.ver2.y == line2.ver1.y):
            # last, but not least, z
            if (line1.ver1.z == line2.ver1.z and line1.ver2.z == line2.ver2.z) or (
                    line1.ver1.z == line2.ver2.z and line1.ver2.z == line2.ver1.z):
